# Archive — plan technique v2

> Statut : document historique. Cette refonte a été abandonnée. Les coches et mentions « complété » reflètent l'état déclaré à l'époque ; elles n'ont pas été revalidées et ne constituent ni l'état de la production, ni la feuille de route du prochain upgrade.

Source : ancien fichier `PlanV2.md` de la branche v2.
